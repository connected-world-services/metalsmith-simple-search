 ...
 *
 * @typedef {Object.<string,module:metalsmith-simple-search~metalsmithFile>} metalsmithFileCollection
 */
 ...
 * });
 *
 * @param {module:metalsmith-simple-search~metalsmithFile} file
 * @param {string} filename
 * @param {module:metalsmith-simple-search~options} options
 * @return {module:metalsmith-simple-search~searchData} search data
 */
